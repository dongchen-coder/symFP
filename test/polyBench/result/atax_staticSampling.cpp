    ...
    for ( int s = 0; s < 20;) {
        ...
        for ( int i = iLB1; i < 1024; i++) {
            ...
            for ( int j = jLB3; j < 1024; j++) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrtmp_addr3( i, j) == calAddrtmp_addr0(i_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
    ...
    for ( int s = 0; s < 400;) {
        ...
        for ( int i = iLB1; i < 1024; i++) {
            ...
            for ( int j = jLB3; j < 1024; j++) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrtmp_addr3( i, j) == calAddrtmp_addr1(i_Start, j_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
    ...
    for ( int s = 0; s < 400;) {
        ...
        for ( int i = iLB1; i < 1024; i++) {
            ...
            for ( int j = jLB3; j < 1024; j++) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrtmp_addr3( i, j) == calAddrtmp_addr2(i_Start, j_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
...
void ref_tmp_addr3() {
    ...
    for ( int s = 0; s < 400;) {
        ...
        for ( int i = iLB1; i < 1024; i++) {
            if (cntStart == true) {
                cnt++;
                if ( calAddrtmp_addr0( i) == calAddrtmp_addr3(i_Start, j_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
            ...
            for ( int j = jLB2; j < 1024; j++) {
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrtmp_addr1( i, j) == calAddrtmp_addr3(i_Start, j_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrtmp_addr2( i, j) == calAddrtmp_addr3(i_Start, j_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
