#ifndef uiIterCodeGen_ref_hpp
#define uiIterCodeGen_ref_hpp
...
namespace uiIterCodeGen_ref {
    struct IterLevelUISamplingCodeGen_ref : public FunctionPass {
        static char ID;
        IterLevelUISamplingCodeGen_ref();
        ...
        /* For each reference, the number of induction variable that will be used to compute its address */
        std::map<string, int> refIndvNumMap;
        ...
        */
        ...
        /* Generate the reuse interval counter code */
        void refRTHistoCollectionGen (
