#ifndef statSchCodeGen_ref_hpp
#define statSchCodeGen_ref_hpp
...
namespace statSchCodeGen_ref {
    struct StaticSchedulingSamplerCodeGen : public FunctionPass {
        static char ID;
		StaticSchedulingSamplerCodeGen();
