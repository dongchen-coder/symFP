...
SAMPLE:
        ...
        if ( prev_cnt_A_addr5 != -1) {
            if ( calAddrA_addr5( t_Start - prev_t_Start_A_addr5 + prev_t_End_A_addr5, i_Start - prev_i_Start_A_addr5 + prev_i_End_A_addr5, j_Start - prev_j_Start_A_addr5 + prev_j_End_A_addr5) == calAddrA_addr0(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr5);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr6 != -1) {
            if ( calAddrA_addr6( t_Start - prev_t_Start_A_addr6 + prev_t_End_A_addr6, i_Start - prev_i_Start_A_addr6 + prev_i_End_A_addr6, j_Start - prev_j_Start_A_addr6 + prev_j_End_A_addr6) == calAddrA_addr0(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr6);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr7 != -1) {
            if ( calAddrA_addr7( t_Start - prev_t_Start_A_addr7 + prev_t_End_A_addr7, i_Start - prev_i_Start_A_addr7 + prev_i_End_A_addr7, j_Start - prev_j_Start_A_addr7 + prev_j_End_A_addr7) == calAddrA_addr0(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr7);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr8 != -1) {
            if ( calAddrA_addr8( t_Start - prev_t_Start_A_addr8 + prev_t_End_A_addr8, i_Start - prev_i_Start_A_addr8 + prev_i_End_A_addr8, j_Start - prev_j_Start_A_addr8 + prev_j_End_A_addr8) == calAddrA_addr0(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr8);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr9 != -1) {
            if ( calAddrA_addr9( t_Start - prev_t_Start_A_addr9 + prev_t_End_A_addr9, i_Start - prev_i_Start_A_addr9 + prev_i_End_A_addr9, j_Start - prev_j_Start_A_addr9 + prev_j_End_A_addr9) == calAddrA_addr0(t_Start, i_Start, j_Start)) {
...
SAMPLE:
        ...
        if ( prev_cnt_A_addr5 != -1) {
            if ( calAddrA_addr5( t_Start - prev_t_Start_A_addr5 + prev_t_End_A_addr5, i_Start - prev_i_Start_A_addr5 + prev_i_End_A_addr5, j_Start - prev_j_Start_A_addr5 + prev_j_End_A_addr5) == calAddrA_addr1(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr5);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr6 != -1) {
            if ( calAddrA_addr6( t_Start - prev_t_Start_A_addr6 + prev_t_End_A_addr6, i_Start - prev_i_Start_A_addr6 + prev_i_End_A_addr6, j_Start - prev_j_Start_A_addr6 + prev_j_End_A_addr6) == calAddrA_addr1(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr6);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr7 != -1) {
            if ( calAddrA_addr7( t_Start - prev_t_Start_A_addr7 + prev_t_End_A_addr7, i_Start - prev_i_Start_A_addr7 + prev_i_End_A_addr7, j_Start - prev_j_Start_A_addr7 + prev_j_End_A_addr7) == calAddrA_addr1(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr7);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr8 != -1) {
            if ( calAddrA_addr8( t_Start - prev_t_Start_A_addr8 + prev_t_End_A_addr8, i_Start - prev_i_Start_A_addr8 + prev_i_End_A_addr8, j_Start - prev_j_Start_A_addr8 + prev_j_End_A_addr8) == calAddrA_addr1(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr8);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr9 != -1) {
            if ( calAddrA_addr9( t_Start - prev_t_Start_A_addr9 + prev_t_End_A_addr9, i_Start - prev_i_Start_A_addr9 + prev_i_End_A_addr9, j_Start - prev_j_Start_A_addr9 + prev_j_End_A_addr9) == calAddrA_addr1(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr9);
                goto EndSample;
            }
        }
...
SAMPLE:
        ...
        if ( prev_cnt_A_addr5 != -1) {
            if ( calAddrA_addr5( t_Start - prev_t_Start_A_addr5 + prev_t_End_A_addr5, i_Start - prev_i_Start_A_addr5 + prev_i_End_A_addr5, j_Start - prev_j_Start_A_addr5 + prev_j_End_A_addr5) == calAddrA_addr2(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr5);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr6 != -1) {
            if ( calAddrA_addr6( t_Start - prev_t_Start_A_addr6 + prev_t_End_A_addr6, i_Start - prev_i_Start_A_addr6 + prev_i_End_A_addr6, j_Start - prev_j_Start_A_addr6 + prev_j_End_A_addr6) == calAddrA_addr2(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr6);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr7 != -1) {
            if ( calAddrA_addr7( t_Start - prev_t_Start_A_addr7 + prev_t_End_A_addr7, i_Start - prev_i_Start_A_addr7 + prev_i_End_A_addr7, j_Start - prev_j_Start_A_addr7 + prev_j_End_A_addr7) == calAddrA_addr2(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr7);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr8 != -1) {
            if ( calAddrA_addr8( t_Start - prev_t_Start_A_addr8 + prev_t_End_A_addr8, i_Start - prev_i_Start_A_addr8 + prev_i_End_A_addr8, j_Start - prev_j_Start_A_addr8 + prev_j_End_A_addr8) == calAddrA_addr2(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr8);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr9 != -1) {
            if ( calAddrA_addr9( t_Start - prev_t_Start_A_addr9 + prev_t_End_A_addr9, i_Start - prev_i_Start_A_addr9 + prev_i_End_A_addr9, j_Start - prev_j_Start_A_addr9 + prev_j_End_A_addr9) == calAddrA_addr2(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr9);
                goto EndSample;
            }
        }
...
SAMPLE:
        ...
        if ( prev_cnt_A_addr5 != -1) {
            if ( calAddrA_addr5( t_Start - prev_t_Start_A_addr5 + prev_t_End_A_addr5, i_Start - prev_i_Start_A_addr5 + prev_i_End_A_addr5, j_Start - prev_j_Start_A_addr5 + prev_j_End_A_addr5) == calAddrA_addr3(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr5);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr6 != -1) {
            if ( calAddrA_addr6( t_Start - prev_t_Start_A_addr6 + prev_t_End_A_addr6, i_Start - prev_i_Start_A_addr6 + prev_i_End_A_addr6, j_Start - prev_j_Start_A_addr6 + prev_j_End_A_addr6) == calAddrA_addr3(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr6);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr7 != -1) {
            if ( calAddrA_addr7( t_Start - prev_t_Start_A_addr7 + prev_t_End_A_addr7, i_Start - prev_i_Start_A_addr7 + prev_i_End_A_addr7, j_Start - prev_j_Start_A_addr7 + prev_j_End_A_addr7) == calAddrA_addr3(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr7);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr8 != -1) {
            if ( calAddrA_addr8( t_Start - prev_t_Start_A_addr8 + prev_t_End_A_addr8, i_Start - prev_i_Start_A_addr8 + prev_i_End_A_addr8, j_Start - prev_j_Start_A_addr8 + prev_j_End_A_addr8) == calAddrA_addr3(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr8);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr9 != -1) {
            if ( calAddrA_addr9( t_Start - prev_t_Start_A_addr9 + prev_t_End_A_addr9, i_Start - prev_i_Start_A_addr9 + prev_i_End_A_addr9, j_Start - prev_j_Start_A_addr9 + prev_j_End_A_addr9) == calAddrA_addr3(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr9);
                goto EndSample;
            }
        }
...
SAMPLE:
        ...
        if ( prev_cnt_A_addr5 != -1) {
            if ( calAddrA_addr5( t_Start - prev_t_Start_A_addr5 + prev_t_End_A_addr5, i_Start - prev_i_Start_A_addr5 + prev_i_End_A_addr5, j_Start - prev_j_Start_A_addr5 + prev_j_End_A_addr5) == calAddrA_addr4(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr5);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr6 != -1) {
            if ( calAddrA_addr6( t_Start - prev_t_Start_A_addr6 + prev_t_End_A_addr6, i_Start - prev_i_Start_A_addr6 + prev_i_End_A_addr6, j_Start - prev_j_Start_A_addr6 + prev_j_End_A_addr6) == calAddrA_addr4(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr6);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr7 != -1) {
            if ( calAddrA_addr7( t_Start - prev_t_Start_A_addr7 + prev_t_End_A_addr7, i_Start - prev_i_Start_A_addr7 + prev_i_End_A_addr7, j_Start - prev_j_Start_A_addr7 + prev_j_End_A_addr7) == calAddrA_addr4(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr7);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr8 != -1) {
            if ( calAddrA_addr8( t_Start - prev_t_Start_A_addr8 + prev_t_End_A_addr8, i_Start - prev_i_Start_A_addr8 + prev_i_End_A_addr8, j_Start - prev_j_Start_A_addr8 + prev_j_End_A_addr8) == calAddrA_addr4(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr8);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr9 != -1) {
            if ( calAddrA_addr9( t_Start - prev_t_Start_A_addr9 + prev_t_End_A_addr9, i_Start - prev_i_Start_A_addr9 + prev_i_End_A_addr9, j_Start - prev_j_Start_A_addr9 + prev_j_End_A_addr9) == calAddrA_addr4(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr9);
                goto EndSample;
            }
        }
...
SAMPLE:
        ...
        /* Generating search reuse body code (use reuse are in the same loop) */
        if ( prev_cnt_A_addr0 != -1) {
            if ( calAddrA_addr0( t_Start - prev_t_Start_A_addr0 + prev_t_End_A_addr0, i_Start - prev_i_Start_A_addr0 + prev_i_End_A_addr0, j_Start - prev_j_Start_A_addr0 + prev_j_End_A_addr0) == calAddrA_addr5(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr0);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr1 != -1) {
            if ( calAddrA_addr1( t_Start - prev_t_Start_A_addr1 + prev_t_End_A_addr1, i_Start - prev_i_Start_A_addr1 + prev_i_End_A_addr1, j_Start - prev_j_Start_A_addr1 + prev_j_End_A_addr1) == calAddrA_addr5(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr1);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr2 != -1) {
            if ( calAddrA_addr2( t_Start - prev_t_Start_A_addr2 + prev_t_End_A_addr2, i_Start - prev_i_Start_A_addr2 + prev_i_End_A_addr2, j_Start - prev_j_Start_A_addr2 + prev_j_End_A_addr2) == calAddrA_addr5(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr2);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr3 != -1) {
            if ( calAddrA_addr3( t_Start - prev_t_Start_A_addr3 + prev_t_End_A_addr3, i_Start - prev_i_Start_A_addr3 + prev_i_End_A_addr3, j_Start - prev_j_Start_A_addr3 + prev_j_End_A_addr3) == calAddrA_addr5(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr3);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr4 != -1) {
            if ( calAddrA_addr4( t_Start - prev_t_Start_A_addr4 + prev_t_End_A_addr4, i_Start - prev_i_Start_A_addr4 + prev_i_End_A_addr4, j_Start - prev_j_Start_A_addr4 + prev_j_End_A_addr4) == calAddrA_addr5(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr4);
                goto EndSample;
            }
        }
        ...
        if ( prev_cnt_A_addr6 != -1) {
            if ( calAddrA_addr6( t_Start - prev_t_Start_A_addr6 + prev_t_End_A_addr6, i_Start - prev_i_Start_A_addr6 + prev_i_End_A_addr6, j_Start - prev_j_Start_A_addr6 + prev_j_End_A_addr6) == calAddrA_addr5(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr6);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr7 != -1) {
            if ( calAddrA_addr7( t_Start - prev_t_Start_A_addr7 + prev_t_End_A_addr7, i_Start - prev_i_Start_A_addr7 + prev_i_End_A_addr7, j_Start - prev_j_Start_A_addr7 + prev_j_End_A_addr7) == calAddrA_addr5(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr7);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr8 != -1) {
            if ( calAddrA_addr8( t_Start - prev_t_Start_A_addr8 + prev_t_End_A_addr8, i_Start - prev_i_Start_A_addr8 + prev_i_End_A_addr8, j_Start - prev_j_Start_A_addr8 + prev_j_End_A_addr8) == calAddrA_addr5(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr8);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr9 != -1) {
            if ( calAddrA_addr9( t_Start - prev_t_Start_A_addr9 + prev_t_End_A_addr9, i_Start - prev_i_Start_A_addr9 + prev_i_End_A_addr9, j_Start - prev_j_Start_A_addr9 + prev_j_End_A_addr9) == calAddrA_addr5(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr9);
                goto EndSample;
            }
        }
...
SAMPLE:
        ...
        /* Generating search reuse body code (use reuse are in the same loop) */
        if ( prev_cnt_A_addr0 != -1) {
            if ( calAddrA_addr0( t_Start - prev_t_Start_A_addr0 + prev_t_End_A_addr0, i_Start - prev_i_Start_A_addr0 + prev_i_End_A_addr0, j_Start - prev_j_Start_A_addr0 + prev_j_End_A_addr0) == calAddrA_addr6(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr0);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr1 != -1) {
            if ( calAddrA_addr1( t_Start - prev_t_Start_A_addr1 + prev_t_End_A_addr1, i_Start - prev_i_Start_A_addr1 + prev_i_End_A_addr1, j_Start - prev_j_Start_A_addr1 + prev_j_End_A_addr1) == calAddrA_addr6(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr1);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr2 != -1) {
            if ( calAddrA_addr2( t_Start - prev_t_Start_A_addr2 + prev_t_End_A_addr2, i_Start - prev_i_Start_A_addr2 + prev_i_End_A_addr2, j_Start - prev_j_Start_A_addr2 + prev_j_End_A_addr2) == calAddrA_addr6(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr2);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr3 != -1) {
            if ( calAddrA_addr3( t_Start - prev_t_Start_A_addr3 + prev_t_End_A_addr3, i_Start - prev_i_Start_A_addr3 + prev_i_End_A_addr3, j_Start - prev_j_Start_A_addr3 + prev_j_End_A_addr3) == calAddrA_addr6(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr3);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr4 != -1) {
            if ( calAddrA_addr4( t_Start - prev_t_Start_A_addr4 + prev_t_End_A_addr4, i_Start - prev_i_Start_A_addr4 + prev_i_End_A_addr4, j_Start - prev_j_Start_A_addr4 + prev_j_End_A_addr4) == calAddrA_addr6(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr4);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr5 != -1) {
            if ( calAddrA_addr5( t_Start - prev_t_Start_A_addr5 + prev_t_End_A_addr5, i_Start - prev_i_Start_A_addr5 + prev_i_End_A_addr5, j_Start - prev_j_Start_A_addr5 + prev_j_End_A_addr5) == calAddrA_addr6(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr5);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr6 != -1) {
            if ( calAddrA_addr6( t_Start - prev_t_Start_A_addr6 + prev_t_End_A_addr6, i_Start - prev_i_Start_A_addr6 + prev_i_End_A_addr6, j_Start - prev_j_Start_A_addr6 + prev_j_End_A_addr6) == calAddrA_addr6(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr6);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr7 != -1) {
            if ( calAddrA_addr7( t_Start - prev_t_Start_A_addr7 + prev_t_End_A_addr7, i_Start - prev_i_Start_A_addr7 + prev_i_End_A_addr7, j_Start - prev_j_Start_A_addr7 + prev_j_End_A_addr7) == calAddrA_addr6(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr7);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr8 != -1) {
            if ( calAddrA_addr8( t_Start - prev_t_Start_A_addr8 + prev_t_End_A_addr8, i_Start - prev_i_Start_A_addr8 + prev_i_End_A_addr8, j_Start - prev_j_Start_A_addr8 + prev_j_End_A_addr8) == calAddrA_addr6(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr8);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr9 != -1) {
            if ( calAddrA_addr9( t_Start - prev_t_Start_A_addr9 + prev_t_End_A_addr9, i_Start - prev_i_Start_A_addr9 + prev_i_End_A_addr9, j_Start - prev_j_Start_A_addr9 + prev_j_End_A_addr9) == calAddrA_addr6(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr9);
                goto EndSample;
            }
        }
...
SAMPLE:
        ...
        /* Generating search reuse body code (use reuse are in the same loop) */
        if ( prev_cnt_A_addr0 != -1) {
            if ( calAddrA_addr0( t_Start - prev_t_Start_A_addr0 + prev_t_End_A_addr0, i_Start - prev_i_Start_A_addr0 + prev_i_End_A_addr0, j_Start - prev_j_Start_A_addr0 + prev_j_End_A_addr0) == calAddrA_addr7(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr0);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr1 != -1) {
            if ( calAddrA_addr1( t_Start - prev_t_Start_A_addr1 + prev_t_End_A_addr1, i_Start - prev_i_Start_A_addr1 + prev_i_End_A_addr1, j_Start - prev_j_Start_A_addr1 + prev_j_End_A_addr1) == calAddrA_addr7(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr1);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr2 != -1) {
            if ( calAddrA_addr2( t_Start - prev_t_Start_A_addr2 + prev_t_End_A_addr2, i_Start - prev_i_Start_A_addr2 + prev_i_End_A_addr2, j_Start - prev_j_Start_A_addr2 + prev_j_End_A_addr2) == calAddrA_addr7(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr2);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr3 != -1) {
            if ( calAddrA_addr3( t_Start - prev_t_Start_A_addr3 + prev_t_End_A_addr3, i_Start - prev_i_Start_A_addr3 + prev_i_End_A_addr3, j_Start - prev_j_Start_A_addr3 + prev_j_End_A_addr3) == calAddrA_addr7(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr3);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr4 != -1) {
            if ( calAddrA_addr4( t_Start - prev_t_Start_A_addr4 + prev_t_End_A_addr4, i_Start - prev_i_Start_A_addr4 + prev_i_End_A_addr4, j_Start - prev_j_Start_A_addr4 + prev_j_End_A_addr4) == calAddrA_addr7(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr4);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr5 != -1) {
            if ( calAddrA_addr5( t_Start - prev_t_Start_A_addr5 + prev_t_End_A_addr5, i_Start - prev_i_Start_A_addr5 + prev_i_End_A_addr5, j_Start - prev_j_Start_A_addr5 + prev_j_End_A_addr5) == calAddrA_addr7(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr5);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr6 != -1) {
            if ( calAddrA_addr6( t_Start - prev_t_Start_A_addr6 + prev_t_End_A_addr6, i_Start - prev_i_Start_A_addr6 + prev_i_End_A_addr6, j_Start - prev_j_Start_A_addr6 + prev_j_End_A_addr6) == calAddrA_addr7(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr6);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr7 != -1) {
            if ( calAddrA_addr7( t_Start - prev_t_Start_A_addr7 + prev_t_End_A_addr7, i_Start - prev_i_Start_A_addr7 + prev_i_End_A_addr7, j_Start - prev_j_Start_A_addr7 + prev_j_End_A_addr7) == calAddrA_addr7(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr7);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr8 != -1) {
            if ( calAddrA_addr8( t_Start - prev_t_Start_A_addr8 + prev_t_End_A_addr8, i_Start - prev_i_Start_A_addr8 + prev_i_End_A_addr8, j_Start - prev_j_Start_A_addr8 + prev_j_End_A_addr8) == calAddrA_addr7(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr8);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr9 != -1) {
            if ( calAddrA_addr9( t_Start - prev_t_Start_A_addr9 + prev_t_End_A_addr9, i_Start - prev_i_Start_A_addr9 + prev_i_End_A_addr9, j_Start - prev_j_Start_A_addr9 + prev_j_End_A_addr9) == calAddrA_addr7(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr9);
                goto EndSample;
            }
        }
...
SAMPLE:
        ...
        /* Generating search reuse body code (use reuse are in the same loop) */
        if ( prev_cnt_A_addr0 != -1) {
            if ( calAddrA_addr0( t_Start - prev_t_Start_A_addr0 + prev_t_End_A_addr0, i_Start - prev_i_Start_A_addr0 + prev_i_End_A_addr0, j_Start - prev_j_Start_A_addr0 + prev_j_End_A_addr0) == calAddrA_addr8(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr0);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr1 != -1) {
            if ( calAddrA_addr1( t_Start - prev_t_Start_A_addr1 + prev_t_End_A_addr1, i_Start - prev_i_Start_A_addr1 + prev_i_End_A_addr1, j_Start - prev_j_Start_A_addr1 + prev_j_End_A_addr1) == calAddrA_addr8(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr1);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr2 != -1) {
            if ( calAddrA_addr2( t_Start - prev_t_Start_A_addr2 + prev_t_End_A_addr2, i_Start - prev_i_Start_A_addr2 + prev_i_End_A_addr2, j_Start - prev_j_Start_A_addr2 + prev_j_End_A_addr2) == calAddrA_addr8(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr2);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr3 != -1) {
            if ( calAddrA_addr3( t_Start - prev_t_Start_A_addr3 + prev_t_End_A_addr3, i_Start - prev_i_Start_A_addr3 + prev_i_End_A_addr3, j_Start - prev_j_Start_A_addr3 + prev_j_End_A_addr3) == calAddrA_addr8(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr3);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr4 != -1) {
            if ( calAddrA_addr4( t_Start - prev_t_Start_A_addr4 + prev_t_End_A_addr4, i_Start - prev_i_Start_A_addr4 + prev_i_End_A_addr4, j_Start - prev_j_Start_A_addr4 + prev_j_End_A_addr4) == calAddrA_addr8(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr4);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr5 != -1) {
            if ( calAddrA_addr5( t_Start - prev_t_Start_A_addr5 + prev_t_End_A_addr5, i_Start - prev_i_Start_A_addr5 + prev_i_End_A_addr5, j_Start - prev_j_Start_A_addr5 + prev_j_End_A_addr5) == calAddrA_addr8(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr5);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr6 != -1) {
            if ( calAddrA_addr6( t_Start - prev_t_Start_A_addr6 + prev_t_End_A_addr6, i_Start - prev_i_Start_A_addr6 + prev_i_End_A_addr6, j_Start - prev_j_Start_A_addr6 + prev_j_End_A_addr6) == calAddrA_addr8(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr6);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr7 != -1) {
            if ( calAddrA_addr7( t_Start - prev_t_Start_A_addr7 + prev_t_End_A_addr7, i_Start - prev_i_Start_A_addr7 + prev_i_End_A_addr7, j_Start - prev_j_Start_A_addr7 + prev_j_End_A_addr7) == calAddrA_addr8(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr7);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr8 != -1) {
            if ( calAddrA_addr8( t_Start - prev_t_Start_A_addr8 + prev_t_End_A_addr8, i_Start - prev_i_Start_A_addr8 + prev_i_End_A_addr8, j_Start - prev_j_Start_A_addr8 + prev_j_End_A_addr8) == calAddrA_addr8(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr8);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr9 != -1) {
            if ( calAddrA_addr9( t_Start - prev_t_Start_A_addr9 + prev_t_End_A_addr9, i_Start - prev_i_Start_A_addr9 + prev_i_End_A_addr9, j_Start - prev_j_Start_A_addr9 + prev_j_End_A_addr9) == calAddrA_addr8(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr9);
                goto EndSample;
            }
        }
...
SAMPLE:
        ...
        /* Generating search reuse body code (use reuse are in the same loop) */
        if ( prev_cnt_A_addr0 != -1) {
            if ( calAddrA_addr0( t_Start - prev_t_Start_A_addr0 + prev_t_End_A_addr0, i_Start - prev_i_Start_A_addr0 + prev_i_End_A_addr0, j_Start - prev_j_Start_A_addr0 + prev_j_End_A_addr0) == calAddrA_addr9(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr0);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr1 != -1) {
            if ( calAddrA_addr1( t_Start - prev_t_Start_A_addr1 + prev_t_End_A_addr1, i_Start - prev_i_Start_A_addr1 + prev_i_End_A_addr1, j_Start - prev_j_Start_A_addr1 + prev_j_End_A_addr1) == calAddrA_addr9(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr1);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr2 != -1) {
            if ( calAddrA_addr2( t_Start - prev_t_Start_A_addr2 + prev_t_End_A_addr2, i_Start - prev_i_Start_A_addr2 + prev_i_End_A_addr2, j_Start - prev_j_Start_A_addr2 + prev_j_End_A_addr2) == calAddrA_addr9(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr2);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr3 != -1) {
            if ( calAddrA_addr3( t_Start - prev_t_Start_A_addr3 + prev_t_End_A_addr3, i_Start - prev_i_Start_A_addr3 + prev_i_End_A_addr3, j_Start - prev_j_Start_A_addr3 + prev_j_End_A_addr3) == calAddrA_addr9(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr3);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr4 != -1) {
            if ( calAddrA_addr4( t_Start - prev_t_Start_A_addr4 + prev_t_End_A_addr4, i_Start - prev_i_Start_A_addr4 + prev_i_End_A_addr4, j_Start - prev_j_Start_A_addr4 + prev_j_End_A_addr4) == calAddrA_addr9(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr4);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr5 != -1) {
            if ( calAddrA_addr5( t_Start - prev_t_Start_A_addr5 + prev_t_End_A_addr5, i_Start - prev_i_Start_A_addr5 + prev_i_End_A_addr5, j_Start - prev_j_Start_A_addr5 + prev_j_End_A_addr5) == calAddrA_addr9(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr5);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr6 != -1) {
            if ( calAddrA_addr6( t_Start - prev_t_Start_A_addr6 + prev_t_End_A_addr6, i_Start - prev_i_Start_A_addr6 + prev_i_End_A_addr6, j_Start - prev_j_Start_A_addr6 + prev_j_End_A_addr6) == calAddrA_addr9(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr6);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr7 != -1) {
            if ( calAddrA_addr7( t_Start - prev_t_Start_A_addr7 + prev_t_End_A_addr7, i_Start - prev_i_Start_A_addr7 + prev_i_End_A_addr7, j_Start - prev_j_Start_A_addr7 + prev_j_End_A_addr7) == calAddrA_addr9(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr7);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr8 != -1) {
            if ( calAddrA_addr8( t_Start - prev_t_Start_A_addr8 + prev_t_End_A_addr8, i_Start - prev_i_Start_A_addr8 + prev_i_End_A_addr8, j_Start - prev_j_Start_A_addr8 + prev_j_End_A_addr8) == calAddrA_addr9(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr8);
                goto EndSample;
            }
        }
        if ( prev_cnt_A_addr9 != -1) {
            if ( calAddrA_addr9( t_Start - prev_t_Start_A_addr9 + prev_t_End_A_addr9, i_Start - prev_i_Start_A_addr9 + prev_i_End_A_addr9, j_Start - prev_j_Start_A_addr9 + prev_j_End_A_addr9) == calAddrA_addr9(t_Start, i_Start, j_Start)) {
                rtHistoCal(prev_cnt_A_addr9);
                goto EndSample;
            }
        }
