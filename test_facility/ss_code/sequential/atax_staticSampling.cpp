...
SAMPLE:
        ...
        for ( int i = iLB1; i < 1024; i++) {
            if (cntStart == true) {
                cnt++;
                if ( calAddrtmp_addr1( i) == calAddrtmp_addr8(i_Start, j_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
            ...
            for ( int j = jLB2; j < 1024; j++) {
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrtmp_addr2( i, j) == calAddrtmp_addr8(i_Start, j_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrtmp_addr5( i, j) == calAddrtmp_addr8(i_Start, j_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
