        ...
        for (int cid = c_Start; cid < chunk_num; cid++) {
            ...
            for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                ...
                if (cntStart == true) {
                    cnt++;
#ifdef DEBUG
                    cout  << "[tmp_addr0]" << it->at(0) << ", cnt: " << cnt << ")	";
#endif
                    if ( calAddrtmp_addr0( it->at(0)) == calAddrtmp_addr0(i_Start)) {
#ifdef DEBUG
                        cout << "[REUSE FIND] @ (" << calAddrtmp_addr0(it->at(0)) << ", " << "(" << it->at(0) << "), " << cnt << ") " << endl;
                        rtHistoCal(cnt, 1);
#else
                        subBlkRT(cnt);
#endif
            ...
            for ( int j = jLB1; j < 4096; j++) {
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        cnt++;
#ifdef DEBUG
                        cout  << "[tmp_addr1]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                        if ( calAddrtmp_addr1( it->at(0), it->at(1)) == calAddrtmp_addr0(i_Start)) {
#ifdef DEBUG
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        cnt++;
#ifdef DEBUG
                        cout  << "[x_addr0]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                    }
                } // end of interleaving loop
#ifdef DEBUG
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        cnt++;
#ifdef DEBUG
                        cout  << "[tmp_addr2]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                        if ( calAddrtmp_addr2( it->at(0), it->at(1)) == calAddrtmp_addr0(i_Start)) {
#ifdef DEBUG
                            cout << "[REUSE FIND] @ (" << calAddrtmp_addr0(it->at(0), it->at(1)) << ", " << "(" << it->at(0) << ", " << it->at(1) << "), " << cnt << ") " << endl;
                            rtHistoCal(cnt, 1);
#else
            ...
            for ( int j = jLB2; j < 4096; j++) {
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        cnt++;
#ifdef DEBUG
                        cout  << "[y_addr0]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                    }
                } // end of interleaving loop
#ifdef DEBUG
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        cnt++;
#ifdef DEBUG
                        cout  << "[tmp_addr3]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                        if ( calAddrtmp_addr3( it->at(0), it->at(1)) == calAddrtmp_addr0(i_Start)) {
#ifdef DEBUG
                            cout << "[REUSE FIND] @ (" << calAddrtmp_addr0(it->at(0), it->at(1)) << ", " << "(" << it->at(0) << ", " << it->at(1) << "), " << cnt << ") " << endl;
                            rtHistoCal(cnt, 1);
#else
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        cnt++;
#ifdef DEBUG
                        cout  << "[y_addr1]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                    }
                } // end of interleaving loop
#ifdef DEBUG
        ...
        for (int cid = c_Start; cid < chunk_num; cid++) {
            ...
            for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                ...
                if (cntStart == true) {
                    ...
                    cout  << "[tmp_addr0]" << it->at(0) << ", cnt: " << cnt << ")	";
#endif
                    if ( calAddrtmp_addr0( it->at(0)) == calAddrtmp_addr1(i_Start, j_Start)) {
#ifdef DEBUG
                        cout << "[REUSE FIND] @ (" << calAddrtmp_addr1(it->at(0)) << ", " << "(" << it->at(0) << "), " << cnt << ") " << endl;
                        rtHistoCal(cnt, 1);
#else
                        subBlkRT(cnt);
#endif
            ...
            for ( int j = jLB1; j < 4096; j++) {
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        ...
                        cout  << "[tmp_addr1]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                        if ( calAddrtmp_addr1( it->at(0), it->at(1)) == calAddrtmp_addr1(i_Start, j_Start)) {
#ifdef DEBUG
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        ...
                        cout  << "[tmp_addr2]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                        if ( calAddrtmp_addr2( it->at(0), it->at(1)) == calAddrtmp_addr1(i_Start, j_Start)) {
#ifdef DEBUG
                            cout << "[REUSE FIND] @ (" << calAddrtmp_addr1(it->at(0), it->at(1)) << ", " << "(" << it->at(0) << ", " << it->at(1) << "), " << cnt << ") " << endl;
                            rtHistoCal(cnt, 1);
#else
            ...
            for ( int j = jLB2; j < 4096; j++) {
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        ...
                        cout  << "[tmp_addr3]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                        if ( calAddrtmp_addr3( it->at(0), it->at(1)) == calAddrtmp_addr1(i_Start, j_Start)) {
#ifdef DEBUG
                            cout << "[REUSE FIND] @ (" << calAddrtmp_addr1(it->at(0), it->at(1)) << ", " << "(" << it->at(0) << ", " << it->at(1) << "), " << cnt << ") " << endl;
                            rtHistoCal(cnt, 1);
#else
        ...
        for (int cid = c_Start; cid < chunk_num; cid++) {
            ...
            for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                ...
                if (cntStart == true) {
                    ...
                    cout  << "[tmp_addr0]" << it->at(0) << ", cnt: " << cnt << ")	";
#endif
                    if ( calAddrtmp_addr0( it->at(0)) == calAddrtmp_addr3(i_Start, j_Start)) {
#ifdef DEBUG
                        cout << "[REUSE FIND] @ (" << calAddrtmp_addr3(it->at(0)) << ", " << "(" << it->at(0) << "), " << cnt << ") " << endl;
                        rtHistoCal(cnt, 1);
#else
                        subBlkRT(cnt);
#endif
            ...
            for ( int j = jLB1; j < 4096; j++) {
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        ...
                        cout  << "[tmp_addr1]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                        if ( calAddrtmp_addr1( it->at(0), it->at(1)) == calAddrtmp_addr3(i_Start, j_Start)) {
#ifdef DEBUG
                            cout << "[REUSE FIND] @ (" << calAddrtmp_addr3(it->at(0), it->at(1)) << ", " << "(" << it->at(0) << ", " << it->at(1) << "), " << cnt << ") " << endl;
                            rtHistoCal(cnt, 1);
#else
                            subBlkRT(cnt);
#endif
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        ...
                        cout  << "[tmp_addr2]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                        if ( calAddrtmp_addr2( it->at(0), it->at(1)) == calAddrtmp_addr3(i_Start, j_Start)) {
#ifdef DEBUG
                            cout << "[REUSE FIND] @ (" << calAddrtmp_addr3(it->at(0), it->at(1)) << ", " << "(" << it->at(0) << ", " << it->at(1) << "), " << cnt << ") " << endl;
                            rtHistoCal(cnt, 1);
#else
            ...
            for ( int j = jLB2; j < 4096; j++) {
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        ...
                        cout  << "[tmp_addr3]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                        if ( calAddrtmp_addr3( it->at(0), it->at(1)) == calAddrtmp_addr3(i_Start, j_Start)) {
#ifdef DEBUG
                            cout << "[REUSE FIND] @ (" << calAddrtmp_addr3(it->at(0), it->at(1)) << ", " << "(" << it->at(0) << ", " << it->at(1) << "), " << cnt << ") " << endl;
                            rtHistoCal(cnt, 1);
#else
...
SAMPLE:
        ...
        record.insert( idx_string );
#ifdef DEBUG
        cout << "[x_addr0]Samples: " << idx_string << endl;
#endif
        uint64_t cnt = 0;
        bool cntStart = false;
            ...
            for ( int j = jLB1; j < 4096; j++) {
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        ...
                        cout  << "[x_addr0]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                        if ( calAddrx_addr0( it->at(0), it->at(1)) == calAddrx_addr0(i_Start, j_Start)) {
#ifdef DEBUG
                            cout << "[REUSE FIND] @ (" << calAddrx_addr0(it->at(0), it->at(1)) << ", " << "(" << it->at(0) << ", " << it->at(1) << "), " << cnt << ") " << endl;
                            rtHistoCal(cnt, 1);
#else
                            subBlkRT(cnt);
#endif
        ...
        for (int cid = c_Start; cid < chunk_num; cid++) {
            ...
            for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                ...
                if (cntStart == true) {
                    ...
                    cout  << "[tmp_addr0]" << it->at(0) << ", cnt: " << cnt << ")	";
#endif
                    if ( calAddrtmp_addr0( it->at(0)) == calAddrtmp_addr2(i_Start, j_Start)) {
#ifdef DEBUG
                        cout << "[REUSE FIND] @ (" << calAddrtmp_addr2(it->at(0)) << ", " << "(" << it->at(0) << "), " << cnt << ") " << endl;
                        rtHistoCal(cnt, 1);
#else
                        subBlkRT(cnt);
#endif
            ...
            for ( int j = jLB1; j < 4096; j++) {
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        ...
                        cout  << "[tmp_addr1]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                        if ( calAddrtmp_addr1( it->at(0), it->at(1)) == calAddrtmp_addr2(i_Start, j_Start)) {
#ifdef DEBUG
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        ...
                        cout  << "[tmp_addr2]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                        if ( calAddrtmp_addr2( it->at(0), it->at(1)) == calAddrtmp_addr2(i_Start, j_Start)) {
#ifdef DEBUG
                            cout << "[REUSE FIND] @ (" << calAddrtmp_addr2(it->at(0), it->at(1)) << ", " << "(" << it->at(0) << ", " << it->at(1) << "), " << cnt << ") " << endl;
                            rtHistoCal(cnt, 1);
#else
            ...
            for ( int j = jLB2; j < 4096; j++) {
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        ...
                        cout  << "[tmp_addr3]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                        if ( calAddrtmp_addr3( it->at(0), it->at(1)) == calAddrtmp_addr2(i_Start, j_Start)) {
#ifdef DEBUG
                            cout << "[REUSE FIND] @ (" << calAddrtmp_addr2(it->at(0), it->at(1)) << ", " << "(" << it->at(0) << ", " << it->at(1) << "), " << cnt << ") " << endl;
                            rtHistoCal(cnt, 1);
#else
...
SAMPLE:
        ...
        record.insert( idx_string );
#ifdef DEBUG
        cout << "[y_addr0]Samples: " << idx_string << endl;
#endif
        uint64_t cnt = 0;
        bool cntStart = false;
            ...
            for ( int j = jLB2; j < 4096; j++) {
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        ...
                        cout  << "[y_addr0]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                        if ( calAddry_addr0( it->at(0), it->at(1)) == calAddry_addr0(i_Start, j_Start)) {
#ifdef DEBUG
                            cout << "[REUSE FIND] @ (" << calAddry_addr0(it->at(0), it->at(1)) << ", " << "(" << it->at(0) << ", " << it->at(1) << "), " << cnt << ") " << endl;
                            rtHistoCal(cnt, 1);
#else
                            subBlkRT(cnt);
#endif
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        ...
                        cout  << "[y_addr1]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                        if ( calAddry_addr1( it->at(0), it->at(1)) == calAddry_addr0(i_Start, j_Start)) {
#ifdef DEBUG
                            cout << "[REUSE FIND] @ (" << calAddry_addr0(it->at(0), it->at(1)) << ", " << "(" << it->at(0) << ", " << it->at(1) << "), " << cnt << ") " << endl;
                            rtHistoCal(cnt, 1);
#else
...
SAMPLE:
        ...
        record.insert( idx_string );
#ifdef DEBUG
        cout << "[y_addr1]Samples: " << idx_string << endl;
#endif
        uint64_t cnt = 0;
        bool cntStart = false;
            ...
            for ( int j = jLB2; j < 4096; j++) {
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        ...
                        cout  << "[y_addr0]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                        if ( calAddry_addr0( it->at(0), it->at(1)) == calAddry_addr1(i_Start, j_Start)) {
#ifdef DEBUG
                            cout << "[REUSE FIND] @ (" << calAddry_addr1(it->at(0), it->at(1)) << ", " << "(" << it->at(0) << ", " << it->at(1) << "), " << cnt << ") " << endl;
                            rtHistoCal(cnt, 1);
#else
                            subBlkRT(cnt);
#endif
                ...
                for (vector<vector<int>>::iterator it = nv.begin(); it != nv.end(); it++) {
                    ...
                    if (cntStart == true) {
                        ...
                        cout  << "[y_addr1]" << it->at(0) << ", " << it->at(1) << ", cnt: " << cnt << ")	";
#endif
                        if ( calAddry_addr1( it->at(0), it->at(1)) == calAddry_addr1(i_Start, j_Start)) {
#ifdef DEBUG
                            cout << "[REUSE FIND] @ (" << calAddry_addr1(it->at(0), it->at(1)) << ", " << "(" << it->at(0) << ", " << it->at(1) << "), " << cnt << ") " << endl;
                            rtHistoCal(cnt, 1);
#else
