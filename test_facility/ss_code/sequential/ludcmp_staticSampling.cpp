...
/* y_addr j 11 */
int calAddry_addr11( int i, int j) {
    int result = (j) * 8 / 64;
    return result;
}
/* y_addr i 12 */
...
/* A_addr ((i * 1024) + i) 16 */
int calAddrA_addr16( int i) {
    int result = (((i * 1024) + i)) * 8 / 64;
    return result;
}
/* x_addr i 17 */
int calAddrx_addr17( int i) {
    int result = (i) * 8 / 64;
    return result;
}
void ref_A_addr0() {
...
SAMPLE:
        ...
        for ( int i = iLB7; i >= 0; i--) {
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrA_addr16( i) == calAddrA_addr0(i_Start, j_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB7; i >= 0; i--) {
            ...
            for ( int j = jLB8; j < 1024; j++) {
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr14( i, j) == calAddrA_addr4(i_Start, j_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrA_addr16( i) == calAddrA_addr4(i_Start, j_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB7; i >= 0; i--) {
            ...
            for ( int j = jLB8; j < 1024; j++) {
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr14( i, j) == calAddrA_addr1(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrA_addr16( i) == calAddrA_addr1(i_Start, j_Start, k_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB7; i >= 0; i--) {
            ...
            for ( int j = jLB8; j < 1024; j++) {
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr14( i, j) == calAddrA_addr6(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrA_addr16( i) == calAddrA_addr6(i_Start, j_Start, k_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB7; i >= 0; i--) {
            ...
            for ( int j = jLB8; j < 1024; j++) {
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr14( i, j) == calAddrA_addr7(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrA_addr16( i) == calAddrA_addr7(i_Start, j_Start, k_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB7; i >= 0; i--) {
            ...
            for ( int j = jLB8; j < 1024; j++) {
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr14( i, j) == calAddrA_addr2(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrA_addr16( i) == calAddrA_addr2(i_Start, j_Start, k_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB7; i >= 0; i--) {
            ...
            for ( int j = jLB8; j < 1024; j++) {
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr14( i, j) == calAddrA_addr3(i_Start, j_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrA_addr16( i) == calAddrA_addr3(i_Start, j_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB7; i >= 0; i--) {
            ...
            for ( int j = jLB8; j < 1024; j++) {
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr14( i, j) == calAddrA_addr10(i_Start, j_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrA_addr16( i) == calAddrA_addr10(i_Start, j_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB5; i < 1024; i++) {
            ...
            for ( int j = jLB6; j < i; j++) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddry_addr11( i, j) == calAddry_addr11(i_Start, j_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr12( i) == calAddry_addr11(i_Start, j_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
        ...
        for ( int i = iLB7; i >= 0; i--) {
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr13( i) == calAddry_addr11(i_Start, j_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB7; i >= 0; i--) {
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrA_addr16( i) == calAddrA_addr5(i_Start, j_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB7; i >= 0; i--) {
            ...
            for ( int j = jLB8; j < 1024; j++) {
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr14( i, j) == calAddrA_addr16(i_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrA_addr16( i) == calAddrA_addr16(i_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB7; i >= 0; i--) {
            ...
            for ( int j = jLB8; j < 1024; j++) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrx_addr15( i, j) == calAddrx_addr17(i_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrx_addr17( i) == calAddrx_addr17(i_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB7; i >= 0; i--) {
            ...
            for ( int j = jLB8; j < 1024; j++) {
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr14( i, j) == calAddrA_addr8(i_Start, j_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrA_addr16( i) == calAddrA_addr8(i_Start, j_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB5; i < 1024; i++) {
            if (cntStart == true) {
                cnt++;
                if ( calAddrb_addr9( i) == calAddrb_addr9(i_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB5; i < 1024; i++) {
            ...
            for ( int j = jLB6; j < i; j++) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddry_addr11( i, j) == calAddry_addr12(i_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
        ...
        for ( int i = iLB7; i >= 0; i--) {
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr13( i) == calAddry_addr12(i_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB7; i >= 0; i--) {
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr13( i) == calAddry_addr13(i_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB7; i >= 0; i--) {
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrA_addr16( i) == calAddrA_addr14(i_Start, j_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB7; i >= 0; i--) {
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrx_addr17( i) == calAddrx_addr15(i_Start, j_Start)) {
                    rtHistoCal(cnt);
                    goto EndSample;
                }
            }
