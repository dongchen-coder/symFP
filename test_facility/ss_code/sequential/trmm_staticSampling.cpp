        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            for ( int j = jLB1; j < 1024; j++) {
                ...
                for ( int k = kLB2; k < 1024; k++) {
                    ...
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrB_addr1( i, j, k) == calAddrB_addr5(i_Start, j_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrB_addr2( i, j, k) == calAddrB_addr5(i_Start, j_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrB_addr3( i, j, k) == calAddrB_addr5(i_Start, j_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrB_addr4( i, j) == calAddrB_addr5(i_Start, j_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            for ( int j = jLB1; j < 1024; j++) {
                ...
                for ( int k = kLB2; k < 1024; k++) {
                    ...
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrB_addr3( i, j, k) == calAddrB_addr1(i_Start, j_Start, k_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrB_addr5( i, j) == calAddrB_addr1(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            for ( int j = jLB1; j < 1024; j++) {
                ...
                for ( int k = kLB2; k < 1024; k++) {
                    ...
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrB_addr3( i, j, k) == calAddrB_addr2(i_Start, j_Start, k_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrB_addr5( i, j) == calAddrB_addr2(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            for ( int j = jLB1; j < 1024; j++) {
                ...
                for ( int k = kLB2; k < 1024; k++) {
                    ...
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrB_addr1( i, j, k) == calAddrB_addr3(i_Start, j_Start, k_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrB_addr2( i, j, k) == calAddrB_addr3(i_Start, j_Start, k_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrB_addr4( i, j) == calAddrB_addr3(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrB_addr5( i, j) == calAddrB_addr3(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            for ( int j = jLB1; j < 1024; j++) {
                ...
                for ( int k = kLB2; k < 1024; k++) {
                    ...
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrB_addr3( i, j, k) == calAddrB_addr4(i_Start, j_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrB_addr5( i, j) == calAddrB_addr4(i_Start, j_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
