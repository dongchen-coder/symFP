        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            for ( int j = jLB3; j < 1024; j++) {
                ...
                for ( int k = kLB4; k < i; k++) {
                    ...
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrA_addr8( i, j, k) == calAddrA_addr4(i_Start, j_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrA_addr9( i, j, k) == calAddrA_addr4(i_Start, j_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrA_addr10( i, j, k) == calAddrA_addr4(i_Start, j_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            for ( int j = jLB3; j < 1024; j++) {
                ...
                for ( int k = kLB4; k < i; k++) {
                    ...
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrA_addr8( i, j, k) == calAddrA_addr5(i_Start, j_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrA_addr9( i, j, k) == calAddrA_addr5(i_Start, j_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrA_addr10( i, j, k) == calAddrA_addr5(i_Start, j_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            for ( int j = jLB3; j < 1024; j++) {
                ...
                for ( int k = kLB4; k < i; k++) {
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrA_addr7( i, j, k) == calAddrA_addr6(i_Start, j_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrA_addr8( i, j, k) == calAddrA_addr6(i_Start, j_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrA_addr9( i, j, k) == calAddrA_addr6(i_Start, j_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrA_addr10( i, j, k) == calAddrA_addr6(i_Start, j_Start)) {
                            rtHistoCal(cnt);
                            goto EndSample;
                        }
                    }
...
SAMPLE:
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            for ( int j = jLB1; j < i; j++) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr6( i, j) == calAddrA_addr7(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
...
SAMPLE:
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            for ( int j = jLB1; j < i; j++) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr4( i, j) == calAddrA_addr8(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr5( i, j) == calAddrA_addr8(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr6( i, j) == calAddrA_addr8(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
...
SAMPLE:
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            for ( int j = jLB1; j < i; j++) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr4( i, j) == calAddrA_addr9(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr5( i, j) == calAddrA_addr9(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr6( i, j) == calAddrA_addr9(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
...
SAMPLE:
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            for ( int j = jLB1; j < i; j++) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr4( i, j) == calAddrA_addr10(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr5( i, j) == calAddrA_addr10(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrA_addr6( i, j) == calAddrA_addr10(i_Start, j_Start, k_Start)) {
                        rtHistoCal(cnt);
                        goto EndSample;
                    }
                }
