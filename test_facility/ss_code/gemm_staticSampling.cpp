...
SAMPLE:
        ...
        if ( prev_cnt_C_addr2 != -1) {
            if ( calAddrC_addr2( i_Start - prev_i_Start_C_addr2 + prev_i_End_C_addr2, j_Start - prev_j_Start_C_addr2 + prev_j_End_C_addr2, k_Start - prev_k_Start_C_addr2 + prev_k_End_C_addr2) == calAddrC_addr2(i_Start, j_Start, k_Start)) {
                rtHistoCal(prev_cnt_C_addr2);
                goto EndSample;
            }
        }
        if ( prev_cnt_C_addr3 != -1) {
            if ( calAddrC_addr3( i_Start - prev_i_Start_C_addr3 + prev_i_End_C_addr3, j_Start - prev_j_Start_C_addr3 + prev_j_End_C_addr3, k_Start - prev_k_Start_C_addr3 + prev_k_End_C_addr3) == calAddrC_addr2(i_Start, j_Start, k_Start)) {
...
SAMPLE:
        ...
        /* Generating search reuse body code (use reuse are in the same loop) */
        if ( prev_cnt_C_addr2 != -1) {
            if ( calAddrC_addr2( i_Start - prev_i_Start_C_addr2 + prev_i_End_C_addr2, j_Start - prev_j_Start_C_addr2 + prev_j_End_C_addr2, k_Start - prev_k_Start_C_addr2 + prev_k_End_C_addr2) == calAddrC_addr3(i_Start, j_Start, k_Start)) {
                rtHistoCal(prev_cnt_C_addr2);
                goto EndSample;
            }
        }
        if ( prev_cnt_C_addr3 != -1) {
            if ( calAddrC_addr3( i_Start - prev_i_Start_C_addr3 + prev_i_End_C_addr3, j_Start - prev_j_Start_C_addr3 + prev_j_End_C_addr3, k_Start - prev_k_Start_C_addr3 + prev_k_End_C_addr3) == calAddrC_addr3(i_Start, j_Start, k_Start)) {
                rtHistoCal(prev_cnt_C_addr3);
                goto EndSample;
            }
        }
