...
/* Array C_addr	i j */ 
/* C_addr ((i * 128) + j) 4 */
int calAddrC_addr4( int i, int j, int k) {
    int result = (((i * 128) + j)) * 8 / 64;
    return result;
}
/* Array C_addr	i j */ 
/* C_addr ((i * 128) + j) 5 */
int calAddrC_addr5( int i, int j, int k) {
    int result = (((i * 128) + j)) * 8 / 64;
    return result;
}
void ref_C_addr4() {
...
SAMPLE:
        ...
        for ( int i = iLB0; i < 128; i=(i + 1)) {
            ...
            for ( int j = jLB1; j < 128; j=(j + 1)) {
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrC_addr0( i, j) == calAddrC_addr4(i_Start, j_Start, k_Start)) {
                            uint64_t parallel_rt = parallel_predict((i_Start -0), i, cnt, 8421376, 8421376, true);
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrC_addr1( i, j) == calAddrC_addr4(i_Start, j_Start, k_Start)) {
                            uint64_t parallel_rt = parallel_predict((i_Start -0), i, cnt, 8421376, 8421376, true);
                            rtHistoCal(RT, parallel_rt, 1.0);
#ifdef DEBUG
                            if (parallel_rt != 1 && parallel_rt != 13) {
                ...
                for ( int k = kLB2; k < 128; k=(k + 1)) {
                    ...
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrC_addr4( i, j, k) == calAddrC_addr4(i_Start, j_Start, k_Start)) {
                                uint64_t parallel_rt = parallel_predict((i_Start -0), i, cnt, 8421376, 8421376, true);
                                rtHistoCal(RT, parallel_rt, 1.0);
#ifdef DEBUG
                                if (parallel_rt != 1 && parallel_rt != 13) {
                    ...
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrC_addr5( i, j, k) == calAddrC_addr4(i_Start, j_Start, k_Start)) {
                                uint64_t parallel_rt = parallel_predict((i_Start -0), i, cnt, 8421376, 8421376, true);
                                rtHistoCal(RT, parallel_rt, 1.0);
#ifdef DEBUG
                                if (parallel_rt != 1 && parallel_rt != 13) {
...
SAMPLE:
        ...
        for ( int i = iLB0; i < 128; i=(i + 1)) {
            ...
            for ( int j = jLB1; j < 128; j=(j + 1)) {
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrC_addr0( i, j) == calAddrC_addr5(i_Start, j_Start, k_Start)) {
                            uint64_t parallel_rt = parallel_predict((i_Start -0), i, cnt, 8421376, 8421376, true);
                            rtHistoCal(RT, parallel_rt, 1.0);
#ifdef DEBUG
                            if (parallel_rt != 1 && parallel_rt != 13) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrC_addr1( i, j) == calAddrC_addr5(i_Start, j_Start, k_Start)) {
                            uint64_t parallel_rt = parallel_predict((i_Start -0), i, cnt, 8421376, 8421376, true);
                            rtHistoCal(RT, parallel_rt, 1.0);
#ifdef DEBUG
                            if (parallel_rt != 1 && parallel_rt != 13) {
                ...
                for ( int k = kLB2; k < 128; k=(k + 1)) {
                    ...
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrC_addr4( i, j, k) == calAddrC_addr5(i_Start, j_Start, k_Start)) {
                                uint64_t parallel_rt = parallel_predict((i_Start -0), i, cnt, 8421376, 8421376, true);
                                rtHistoCal(RT, parallel_rt, 1.0);
#ifdef DEBUG
                                if (parallel_rt != 1 && parallel_rt != 13) {
                    ...
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrC_addr5( i, j, k) == calAddrC_addr5(i_Start, j_Start, k_Start)) {
                                uint64_t parallel_rt = parallel_predict((i_Start -0), i, cnt, 8421376, 8421376, true);
                                rtHistoCal(RT, parallel_rt, 1.0);
#ifdef DEBUG
                                if (parallel_rt != 1 && parallel_rt != 13) {
        ...
        for ( int i = iLB0; i < 128; i=(i + 1)) {
            ...
            for ( int j = jLB1; j < 128; j=(j + 1)) {
                ...
                for ( int k = kLB2; k < 128; k=(k + 1)) {
                    ...
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrC_addr4( i, j, k) == calAddrC_addr0(i_Start, j_Start)) {
                                uint64_t parallel_rt = parallel_predict((i_Start -0), i, cnt, 8421376, 8421376, true);
                                rtHistoCal(RT, parallel_rt, 1.0);
#ifdef DEBUG
                                if (parallel_rt != 1 && parallel_rt != 13) {
                    ...
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrC_addr5( i, j, k) == calAddrC_addr0(i_Start, j_Start)) {
                                uint64_t parallel_rt = parallel_predict((i_Start -0), i, cnt, 8421376, 8421376, true);
                                rtHistoCal(RT, parallel_rt, 1.0);
#ifdef DEBUG
                                if (parallel_rt != 1 && parallel_rt != 13) {
        ...
        for ( int i = iLB0; i < 128; i=(i + 1)) {
            ...
            for ( int j = jLB1; j < 128; j=(j + 1)) {
                ...
                for ( int k = kLB2; k < 128; k=(k + 1)) {
                    ...
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrC_addr4( i, j, k) == calAddrC_addr1(i_Start, j_Start)) {
                                uint64_t parallel_rt = parallel_predict((i_Start -0), i, cnt, 8421376, 8421376, true);
                                rtHistoCal(RT, parallel_rt, 1.0);
#ifdef DEBUG
                                if (parallel_rt != 1 && parallel_rt != 13) {
                    ...
                    if (cntStart == true) {
                        cnt++;
                        if ( calAddrC_addr5( i, j, k) == calAddrC_addr1(i_Start, j_Start)) {
                                uint64_t parallel_rt = parallel_predict((i_Start -0), i, cnt, 8421376, 8421376, true);
                                rtHistoCal(RT, parallel_rt, 1.0);
#ifdef DEBUG
                                if (parallel_rt != 1 && parallel_rt != 13) {
                ...
                for ( int k = kLB2; k < 128; k=(k + 1)) {
                    ...
                    if (cntStart == true) {
                        ...
                        if ( calAddrB_addr3( i, j, k) == calAddrB_addr3(i_Start, j_Start, k_Start)) {
                                uint64_t parallel_rt = parallel_predict((i_Start -0), i, cnt, 8421376, 8421376, false);
                                rtHistoCal(RT, parallel_rt, 1.0);
#ifdef DEBUG
                                if (parallel_rt != 1 && parallel_rt != 13) {
                                    cout << "[" << parallel_rt << "] (" << i_Start<< ", " << j_Start<< ", " << k_Start<< ") -- (" << i<< ", " << j<< ", " << k<< ") " << endl;
