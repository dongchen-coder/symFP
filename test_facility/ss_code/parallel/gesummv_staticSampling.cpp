...
SAMPLE:
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrtmp_addr3( thread_i) == calAddrtmp_addr0(i_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
#ifdef DEBUG
                if (cntStart == true) {
                    cout << "(" << calAddrtmp_addr3(thread_i) << ", " << "(" << thread_i << "), " << cnt << ") " << endl;
                }
#endif
            } // end of interleaving loop
#ifdef DEBUG
...
SAMPLE:
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr0( thread_i) == calAddry_addr1(i_Start, j_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr3( thread_i) == calAddry_addr1(i_Start, j_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
#ifdef DEBUG
                if (cntStart == true) {
                    cout << "(" << calAddry_addr3(thread_i) << ", " << "(" << thread_i << ", " << "), " << cnt << ") " << endl;
                }
#endif
            } // end of interleaving loop
#ifdef DEBUG
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr4( thread_i) == calAddry_addr1(i_Start, j_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
#ifdef DEBUG
                if (cntStart == true) {
                    cout << "(" << calAddry_addr4(thread_i) << ", " << "(" << thread_i << ", " << "), " << cnt << ") " << endl;
                }
#endif
            } // end of interleaving loop
#ifdef DEBUG
...
SAMPLE:
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr3( thread_i) == calAddry_addr0(i_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr4( thread_i) == calAddry_addr0(i_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr0( thread_i) == calAddry_addr3(i_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
            ...
            for ( int j = jLB1; j < 1024; j++) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddry_addr1( thread_i, thread_j) == calAddry_addr3(i_Start)) {
                            subBlkRT(cnt);
                        goto EndSample;
                    }
                }
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddry_addr2( thread_i, thread_j) == calAddry_addr3(i_Start)) {
                            subBlkRT(cnt);
                        goto EndSample;
                    }
                }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr3( thread_i) == calAddry_addr3(i_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr4( thread_i) == calAddry_addr3(i_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr0( thread_i) == calAddry_addr4(i_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
            ...
            for ( int j = jLB1; j < 1024; j++) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddry_addr1( thread_i, thread_j) == calAddry_addr4(i_Start)) {
                            subBlkRT(cnt);
                        goto EndSample;
                    }
                }
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddry_addr2( thread_i, thread_j) == calAddry_addr4(i_Start)) {
                            subBlkRT(cnt);
                        goto EndSample;
                    }
                }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr3( thread_i) == calAddry_addr4(i_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr4( thread_i) == calAddry_addr4(i_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrtmp_addr3( thread_i) == calAddrtmp_addr1(i_Start, j_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrtmp_addr3( thread_i) == calAddrtmp_addr2(i_Start, j_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr0( thread_i) == calAddry_addr2(i_Start, j_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr3( thread_i) == calAddry_addr2(i_Start, j_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddry_addr4( thread_i) == calAddry_addr2(i_Start, j_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
...
SAMPLE:
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrtmp_addr0( thread_i) == calAddrtmp_addr3(i_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
            ...
            for ( int j = jLB1; j < 1024; j++) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrtmp_addr1( thread_i, thread_j) == calAddrtmp_addr3(i_Start)) {
                            subBlkRT(cnt);
                        goto EndSample;
                    }
                }
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrtmp_addr2( thread_i, thread_j) == calAddrtmp_addr3(i_Start)) {
                            subBlkRT(cnt);
                        goto EndSample;
                    }
                }
            ...
            if (cntStart == true) {
                cnt++;
                if ( calAddrtmp_addr3( thread_i) == calAddrtmp_addr3(i_Start)) {
                        subBlkRT(cnt);
                    goto EndSample;
                }
            }
