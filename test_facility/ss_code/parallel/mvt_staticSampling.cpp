...
SAMPLE:
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            for ( int j = jLB1; j < 1024; j++) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrx1_addr0( thread_i, thread_j) == calAddrx1_addr0(i_Start, j_Start)) {
                            subBlkRT(cnt);
                        goto EndSample;
                    }
                }
...
#ifdef DEBUG
                    if (cntStart == true) {
                        cout << "(" << calAddrx1_addr0(thread_i, thread_j) << ", " << "(" << thread_i << ", "<< thread_j << "), " << cnt << ") " << endl;
                    }
#endif
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrx1_addr1( thread_i, thread_j) == calAddrx1_addr0(i_Start, j_Start)) {
                            subBlkRT(cnt);
                        goto EndSample;
                    }
                }
#ifdef DEBUG
                    if (cntStart == true) {
                        cout << "(" << calAddrx1_addr1(thread_i, thread_j) << ", " << "(" << thread_i << ", "<< thread_j << "), " << cnt << ") " << endl;
                    }
#endif
                } // end of interleaving loop
#ifdef DEBUG
...
SAMPLE:
        ...
        for ( int i = iLB0; i < 1024; i++) {
            ...
            for ( int j = jLB1; j < 1024; j++) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrx1_addr0( thread_i, thread_j) == calAddrx1_addr1(i_Start, j_Start)) {
                            subBlkRT(cnt);
                        goto EndSample;
                    }
                }
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrx1_addr1( thread_i, thread_j) == calAddrx1_addr1(i_Start, j_Start)) {
                            subBlkRT(cnt);
                        goto EndSample;
                    }
                }
...
SAMPLE:
        ...
        for ( int i = iLB2; i < 1024; i++) {
            ...
            for ( int j = jLB3; j < 1024; j++) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrx2_addr0( thread_i, thread_j) == calAddrx2_addr0(i_Start, j_Start)) {
                            subBlkRT(cnt);
                        goto EndSample;
                    }
                }
...
#ifdef DEBUG
                    if (cntStart == true) {
                        cout << "(" << calAddrx2_addr0(thread_i, thread_j) << ", " << "(" << thread_i << ", "<< thread_j << "), " << cnt << ") " << endl;
                    }
#endif
                } // end of interleaving loop
#ifdef DEBUG
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrx2_addr1( thread_i, thread_j) == calAddrx2_addr0(i_Start, j_Start)) {
                            subBlkRT(cnt);
                        goto EndSample;
                    }
                }
#ifdef DEBUG
                    if (cntStart == true) {
                        cout << "(" << calAddrx2_addr1(thread_i, thread_j) << ", " << "(" << thread_i << ", "<< thread_j << "), " << cnt << ") " << endl;
                    }
#endif
                } // end of interleaving loop
#ifdef DEBUG
...
SAMPLE:
        ...
        for ( int i = iLB2; i < 1024; i++) {
            ...
            for ( int j = jLB3; j < 1024; j++) {
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrx2_addr0( thread_i, thread_j) == calAddrx2_addr1(i_Start, j_Start)) {
                            subBlkRT(cnt);
                        goto EndSample;
                    }
                }
                ...
                if (cntStart == true) {
                    cnt++;
                    if ( calAddrx2_addr1( thread_i, thread_j) == calAddrx2_addr1(i_Start, j_Start)) {
                            subBlkRT(cnt);
                        goto EndSample;
                    }
                }
